...
latex_documents = [
    (master_doc, 'biobb.tex', u'biobb Documentation',
...
man_pages = [
    (master_doc, 'biobb', u'biobb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb', u'biobb Documentation',
     author, 'biobb', 'biobb molecular dynamics building blocks',
     'Miscellaneous'),
]
